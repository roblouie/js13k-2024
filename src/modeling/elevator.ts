import { buildSegmentedWall, createBox, DoorWith, SegmentedWall } from '@/modeling/building-blocks';
...
export function buildElevator() {
  const testWall = buildSegmentedWall([4, DoorWith * 2, 4], 12, [12, 3, 12], [0, 0, 0], 0, 0);
